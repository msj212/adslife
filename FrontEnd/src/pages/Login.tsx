      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-10">
        <div className="w-full max-w-sm">
          ...
          <div className="mt-4 p-3 rounded-xl bg-[var(--surface-2)] border border-[var(--border)]">
            <p className="text-xs text-[var(--text-secondary)] mb-1 font-medium">Demo credentials</p>
            <p className="text-xs text-[var(--text-muted)] font-mono">arjun@demo.com / password123</p>
          </div>
